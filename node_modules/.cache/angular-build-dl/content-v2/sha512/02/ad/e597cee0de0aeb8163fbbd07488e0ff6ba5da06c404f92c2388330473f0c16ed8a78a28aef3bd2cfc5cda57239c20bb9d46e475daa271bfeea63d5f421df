...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["modules-addnewpost-addnewpost-routing-module"], {
  ...
  function srcModulesAddnewpostComponentsAddnewpostAddnewpostComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var AddNewPostComponent = /*#__PURE__*/function () {
      function AddNewPostComponent(postservice, firestore) {
    ...
    }), Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"])("design:paramtypes", [_services_post_service__WEBPACK_IMPORTED_MODULE_3__["PostService"], _angular_fire_firestore__WEBPACK_IMPORTED_MODULE_2__["AngularFirestore"]])], AddNewPostComponent);
    /***/
  },
